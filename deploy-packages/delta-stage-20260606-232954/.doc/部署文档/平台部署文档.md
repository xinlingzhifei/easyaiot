# yFeiEye Platform Deployment Documentation
...
yFeiEye is a cloud-edge integrated intelligent algorithm application platform that uses a unified installation script for one-click deployment. The platform supports Docker containerized deployment and can quickly install and start all service modules.

### Platform Architecture

The yFeiEye platform consists of the following core modules:
...
- Create unified network `yfeieye-network`
...
2. Create Docker network `yfeieye-network`
...
- All service images
- All data volumes
- Docker network `yfeieye-network`
