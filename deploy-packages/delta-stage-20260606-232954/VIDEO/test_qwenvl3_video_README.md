...
```bash
python test_qwenvl3_video.py /opt/projects/yfeieye/VIDEO/video/video2.mp4
```

### 示例 2：提取更多帧

```bash
python test_qwenvl3_video.py /opt/projects/yfeieye/VIDEO/video/video2.mp4 --num-frames 8
```
