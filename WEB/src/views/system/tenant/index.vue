...
<template>
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        <Button v-auth="['system:tenant:create']" type="primary" :preIcon="IconEnum.ADD" @click="handleCreate">
          {{ t('action.create') }}
        </Button>
        <Button v-auth="['system:tenant:export']" :preIcon="IconEnum.EXPORT" @click="handleExport">
          {{ t('action.export') }}
        </Button>
      </template>
