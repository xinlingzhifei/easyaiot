...
| FR-17 | `GET /cases/{id}/evidence-audit`, `POST /evidence-export-jobs/{jobNo}/downloads` | `system_supervision_alert_review_case_audit`, `system_supervision_alert_review_export_job` | `evidenceAuditTrailListsHashesExporterDownloadsAndBoundEvents`, `evidenceAuditTrailIncludesMediaAccessReadsWithOperatorAndReverseLookup`, `evidenceManifestV2AndVerifierReconstructDecisionTrailAndAuditChain` | `J1`, `V1` |
