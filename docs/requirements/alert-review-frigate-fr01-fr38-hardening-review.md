...
| FR-21 | `HttpAlertRecordEvidenceResolver`, `HttpVideoRecordCoverageResolver`, docker compose env | `application.yaml`, `DEVICE/docker-compose.yml`, `.scripts/alert-review-video-live-smoke.mjs` | `dockerComposeWiresReviewVideoUrlsToRealVideoRecordEndpointsByDefault`, coverage resolver injection alias guard, `videoEvidenceExportProviderPostsExportWindowAndRewritesRelativeExportUrl`, `alert-review-video-live-smoke.test.mjs` | `J1`, `LiveVideo`, `Smoke` |
