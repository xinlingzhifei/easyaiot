...
- `PG1`: `node .scripts/alert-review-postgres-migration-smoke.mjs --container=<postgres-container>`; applies `V20260702`, `V20260704`, `V20260705`, and `V20260706` to a temporary database and verifies FR-01 ingest identity, FR-19 ReviewData backfill, FR-20 ReviewSegment constraints, and FR-23 media permission seeds against PostgreSQL.
