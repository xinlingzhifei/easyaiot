...
- `PG1`: `node .scripts/alert-review-postgres-migration-smoke.mjs --container=<postgres-container>`; applies `V20260702`, `V20260704`, `V20260705`, `V20260706`, `V20260707`, `V20260708`, `V20260708_2`, `V20260708_3`, `V20260708_4`, and `V20260708_5` to a temporary database and verifies FR-01 ingest identity, FR-03 review status/version stale writes and concurrent races, FR-19 ReviewData backfill, FR-20 ReviewSegment overlap and status-transition constraints, FR-23 media permission seeds, FR-23 item-level media audit lookup, FR-24/FR-30/FR-33/FR-35 paused scheduler seeds, FR-35 report acknowledgement DDL, runtime outbox notify template seeds, and runtime outbox recipient delivery idempotency DDL against PostgreSQL.
