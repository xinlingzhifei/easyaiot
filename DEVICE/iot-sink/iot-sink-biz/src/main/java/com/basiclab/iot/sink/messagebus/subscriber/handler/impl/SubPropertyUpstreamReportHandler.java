...
@Slf4j
@Component
public class SubPropertyUpstreamReportHandler extends AbstractTopicHandler implements IotUpstreamMessageHandler {

    @Override
    public boolean handleUpstreamMessage(IotDeviceMessage message) {
        return handleAndPublishEvent(message, IotDeviceTopicEnum.SUB_PROPERTY_UPSTREAM_REPORT);
    }
}
