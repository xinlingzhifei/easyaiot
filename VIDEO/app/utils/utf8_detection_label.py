...
OpenCV 的 Hershey 字体只适合 ASCII 文本。中文类别名使用 Pillow 和 CJK 字体
在局部 ROI 上绘制，避免整帧颜色空间转换带来的额外开销。
"""
...
def draw_detection_label(
    ...
    *,
    ...
    返回 True 表示使用 Pillow 成功绘制 UTF-8 文本；ASCII 或缺少 CJK 字体时
    使用 OpenCV 并返回 False。
    """
