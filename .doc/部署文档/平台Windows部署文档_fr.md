# Guide de déploiement local de la plateforme yFeiEye pour Windows
...
yFeiEye est une plateforme d'analyse vidéo IoT + IA qui prend en charge la connexion de caméras, la redirection de flux vidéo et l'analyse d'algorithmes IA.
