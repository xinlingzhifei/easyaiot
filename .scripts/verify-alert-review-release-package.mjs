...
export const FR_RELEASE_PATH_RULES = [
  ...
  },
  {
    ...
    match:
      /^DEVICE\/iot-system\/iot-system-biz\/src\/main\/resources\/(schemas\/alert-review-|sql\/migrations\/V2026070[2456]__alert_review_(frigate_hardening|segment_tenant_scope|review_data_backfill|media_permissions)\.sql|sql\/supervision_event_closure_v1\.sql)/,
  },
  {
