  ...
  >
    <view class="yd-search-form-container">
      ...
      <view class="yd-search-form-item">
        ...
        <wd-radio-group v-model="formData.online" type="button">
          <wd-radio value="">
            全部
          </wd-radio>
          <wd-radio value="true">
...
const placeholder = computed(() => {
  ...
  if (formData.online === 'true')
    parts.push('在线')
  if (formData.online === 'false')
    parts.push('离线')
  return parts.length ? parts.join(' | ') : '搜索设备'
})
...
function handleSearch() {
  ...
  emit('search', {
    ...
    online: formData.online === '' ? undefined : formData.online === 'true',
  })
}
