    ...
    <view class="auth-content">
      ...
      <view class="form-container">
        ...
        <view class="mb-24rpx flex items-center">
          ...
          <text class="text-24rpx text-[#266cfb]" @click="goToUserAgreement">
            《用户协议》
          </text>
          <text class="text-24rpx text-[#666]">与</text>
          <text class="text-24rpx text-[#266cfb]" @click="goToPrivacyPolicy">
            《隐私政策》
          </text>
        </view>
        ...
        <view class="auth-footer">
          ...
          <text class="auth-footer__link" @click="goToLogin">去登录</text>
        </view>
      </view>
    </view>
  </view>
